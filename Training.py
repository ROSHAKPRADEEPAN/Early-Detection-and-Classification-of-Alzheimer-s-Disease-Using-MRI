...
PATH = r'C:\Final_yr_Project\Alzheimer-Disease-Detection-using-CNN-and-LSTM-with-MRI-Scans-main'
...
def build_model():
    ...
    model.add(MaxPooling2D(pool_size=(2, 2)))
    model.add(Flatten())  # Replace TimeDistributed(Flatten()) and LSTM with Flatten
